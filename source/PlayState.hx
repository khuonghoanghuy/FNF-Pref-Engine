...
class PlayState extends MusicBeatState
{
	...
	function cancelTween(object:FlxObject) {
		return FlxTween.cancelTweensOf(object);
	}
	...
	private function keyShit():Void
	{
		...
		if (boyfriend.holdTimer > Conductor.stepCrochet * 4 * 0.001 && !upR && !downR && !rightR && !leftR)
		{
